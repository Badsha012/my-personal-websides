...
import futureImg1 from "../assets/future.avif";
  ...
  return (
    <section className="bg-slate-900 rounded-xl p-6 md:p-10 shadow-lg">
      ...
      <p className="text-slate-300 leading-relaxed text-justify">
        ...
        দায়িত্বশীল ও যোগ্য পেশাজীবী হিসেবে প্রতিষ্ঠিত করা। আমি এমন একটি অবস্থানে
        পৌঁছাতে চাই, যেখানে আমার জ্ঞান ও দক্ষতা সমাজের কল্যাণে ব্যবহার করতে
        পারবো। ব্যক্তিগত সাফল্যের পাশাপাশি সমাজে ইতিবাচক অবদান রাখাই আমার
        দীর্ঘমেয়াদি স্বপ্ন।
        <br /><br />
        ...
        শেখার প্রক্রিয়া কখনো বন্ধ করবো না। কারণ আমার কাছে জীবন মানে শুধু এগিয়ে
        যাওয়া নয়, বরং প্রতিদিন নিজের সেরা সংস্করণ হয়ে ওঠা।
      </p>
    </section>
  );
};
